...
def parse_args():
    ...
    parser.add_argument('--ns_q', type=int)
    ...
    parser.add_argument('--dict_mode', choices=('tag_sum', 'tag_max', 'per_rel'))
    ...
    parser.add_argument('--ppr_k', type=int)
    parser.add_argument('--top_k_relation', type=int, default=0)
    parser.add_argument('--ppr_alpha', type=float)
    parser.add_argument('--ppr_beta', type=float)
    parser.add_argument('--gamma', type=float)
    parser.add_argument('--direct_single_hop', type=float)
    parser.add_argument('--decay_direct', type=float)
