...
def parse_args():
    ...
    parser.add_argument('--dict_mode', choices=('tag_sum', 'tag_max', 'per_rel'), required=True)
    ...
    parser.add_argument('--direct_single_hop', type=float, required=True)
    parser.add_argument('--decay_direct', type=float, required=True)
